<form class="flex items-center" action="{{ route($routerName, $params ?? '') }}" method="get">
    ...
    <div class="relative w-1/3">
        ...
        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 " placeholder="Pesquisar" name='filter' value="{{ request('filter') }}">
    </div>
